...
!function (e) {
  ...
  var E = {classPrefix: 'hljs-', tabReplace: null, useBR: !1, languages: void 0}, x = {}, R = {};
  return e.highlight = f, e.highlightAuto = l, e.fixMarkup = g, e.highlightBlock = p, e.configure = d, e.initHighlighting = b, e.initHighlightingOnLoad = v, e.registerLanguage = m, e.listLanguages = N, e.getLanguage = w, e.inherit = o, e.IR = '[a-zA-Z]\\w*', e.UIR = '[a-zA-Z_]\\w*', e.NR = '\\b\\d+(\\.\\d+)?', e.CNR = '(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)', e.BNR = '\\b(0b[01]+)', e.RSR = '!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~', e.BE = {
    ...
    i: '\\n',
    c: [e.BE]
  }, e.PWM = {b: /\b(a|an|the|are|I|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such)\b/}, e.C = function (n, t, r) {
...
hljs.registerLanguage('ruby', function (e) {
  var c = '[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?', r = 'and false then defined module in return redo if BEGIN retry end for true self when next until do begin unless END rescue nil else break undef not super class case require yield alias while ensure elsif or include attr_reader attr_writer attr_accessor', b = {
    cN: 'doctag',
    b: '@[A-Za-z]+'
  }, a = {cN: 'value', b: '#<', e: '>'}, n = [e.C('#', '$', {c: [b]}), e.C('^\\=begin', '^\\=end', {
    c: [b],
    r: 10
  ...
  }, {cN: 'function', bK: 'def', e: '$|;', c: [e.inherit(e.TM, {b: c}), i].concat(n)}, {
    cN: 'constant',
    b: '(::)?(\\b[A-Z]\\w*(::)?)+',
    r: 0
  }, {cN: 'symbol', b: e.UIR + '(\\!|\\?)?:', r: 0}, {cN: 'symbol', b: ':', c: [t, {b: c}], r: 0}, {
    cN: 'number',
...
//  var s = '[A-Za-z0-9\\._:-]+', c = {b: /<\?(php)?(?!\w)/, e: /\?>/, sL: 'php'}, e = {
//    eW: !0,
//    i: /</,
//    r: 0,
//    c: [c, {cN: 'attribute', b: s, r: 0}, {
//      b: '=',
//      r: 0,
//      c: [{cN: 'value', c: [c], v: [{b: /'/, e: /'/}, {b: /'/, e: /'/}, {b: /[^\s\/>]+/}]}]
//    }]
//  };
//  return {
...
//      r: 10,
//      c: [{b: '\\[', e: '\\]'}]
//    }, t.C('<!--', '-->', {r: 10}), {cN: 'cdata', b: '<\\!\\[CDATA\\[', e: '\\]\\]>', r: 10}, {
//      cN: 'tag',
//      b: '<style(?=\\s|>|$)',
//      e: '>',
//      k: {title: 'style'},
...
hljs.registerLanguage('css', function (e) {
  var c = '[a-zA-Z-][a-zA-Z0-9_-]*', a = {cN: 'function', b: c + '\\(', rB: !0, eE: !0, e: '\\('}, r = {
    cN: "rule",
    b: /[A-Z\_\.\-]+\s*:/,
    rB: !0,
    e: ";",
  ...
  return {
    cI: !0,
    i: /[=\/|'\$]/,
    c: [e.CBCM, r, {cN: "id", b: /\#[A-Za-z0-9_-]+/}, {cN: "class", b: /\.[A-Za-z0-9_-]+/}, {
      cN: "attr_selector",
      b: /\[/,
      e: /\]/,
      i: "$"
    ...
    }, {cN: "tag", b: c, r: 0}, {cN: "rules", b: "{", e: "}", i: /\S/, c: [e.CBCM, r]}]
  }
});
hljs.registerLanguage("perl", function (e) {
  ...
  }, o = [e.BE, r, n], i = [n, e.HCM, e.C("^\\=\\w", "\\=cut", {eW: !0}), s, {
    cN: "string",
    c: o,
  ...
  return r.c = i, s.c = i, {aliases: ["pl"], k: t, c: i}
});
...
hljs.registerLanguage("objectivec", function (e) {
  ...
  }, o = /[a-zA-Z@][a-zA-Z0-9_]*/, n = "@interface @class @protocol @implementation";
  return {
...
hljs.registerLanguage("java", function (e) {
  var a = e.UIR + "(<" + e.UIR + ">)?", t = "false synchronized int abstract float private char boolean static null if const for true while long strictfp finally protected import native final void enum else break transient catch instanceof byte super volatile case assert short package default double public try this switch continue throws protected public private", c = "\\b(0[bB]([01]+[01_]+[01]+|[01]+)|0[xX]([a-fA-F0-9]+[a-fA-F0-9_]+[a-fA-F0-9]+|[a-fA-F0-9]+)|(([\\d]+[\\d_]+[\\d]+|[\\d]+)(\\.([\\d]+[\\d_]+[\\d]+|[\\d]+))?|\\.([\\d]+[\\d_]+[\\d]+|[\\d]+))([eE][-+]?\\d+)?)[lLfF]?", r = {
    cN: "number",
    b: c,
    r: 0
  };
...
hljs.registerLanguage("nginx", function (e) {
  ...
  return {
    aliases: ["nginxconf"],
    c: [e.HCM, {b: e.UIR + "\\s", e: ";|{", rB: !0, c: [{cN: "title", b: e.UIR, starts: b}], r: 0}],
    i: "[^\\s\\}]"
  }
});
...
hljs.registerLanguage("php", function (e) {
  var c = {cN: "variable", b: "\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*"}, a = {
    cN: "preprocessor",
    b: /<\?(php)?|\?>/
  }, i = {
    cN: "string",
...
hljs.registerLanguage("coffeescript", function (e) {
  var c = {
    ...
    e: /}/,
    k: c
  }, t = [e.BNM, e.inherit(e.CNM, {starts: {e: "(\\s*/)?", r: 0}}), {
    cN: "string",
  ...
  r.c = t;
  var s = e.inherit(e.TM, {b: n}), i = "(\\(.*\\))?\\s*\\B[-=]>", o = {
    cN: "params",
    b: "\\([^\\(]",
    rB: !0,
    c: [{b: /\(/, e: /\)/, k: c, c: ["self"].concat(t)}]
  };
  return {
    ...
    c: t.concat([e.C("###", "###"), e.HCM, {
      ...
      rB: !0,
      c: [s, o]
    }, {b: /[:\(,=]\s*/, r: 0, c: [{cN: "function", b: i, e: "[-=]>", rB: !0, c: [o]}]}, {
      cN: "class",
      bK: "class",
      e: "$",
      i: /[:="\[\]]/,
  ...
  return {
    ...
    c: [e.C(";", "$"), e.HCM, {cN: "title", b: /^\s*\[+/, e: /\]+/}, {
      ...
      c: [{
        ...
        c: [{cN: "variable", v: [{b: /\$[\w\d"][\w\d_]*/}, {b: /\$\{(.*?)}/}]}, c, {
          cN: "number",
          b: /([\+\-]+)?[\d]+_[\d_]+/
        }, e.NM],
        r: 0
